...
def create_sample_features(player_name: str, team: str, batting_order: int,
    ...
    # Determine if it's a night game based on current time
    current_hour = datetime.now().hour
    is_night_game = 1.0 if current_hour >= 18 or current_hour < 6 else 0.0
    ...
    features = [
        ...
        is_night_game,  # Night game (based on current time)
...
def main():
    ...
    print("\nTesting enhanced weather integration...")
