...
class MLBBettingSystem:
    ...
    def update_historical_data(self):
        ...
        try:
            historical_df = pd.read_csv('data/historical_mlb_games.csv')
        ...
        if new_games:
            ...
            # Save updated data
            updated_df.to_csv('data/historical_mlb_games.csv', index=False)
            ...
            for game in new_games[-5:]:  # Show last 5 added
                winner_indicator = "HOME" if game['winner'] == 'home' else "AWAY"
            ...
            print("RETRAIN: New games detected - will retrain model with fresh data")
    ...
    def force_model_retrain(self):
        ...
        model_files = ['models/production_mlb_model.pkl']
    ...
    def load_historical_data(self):
        ...
        try:
            self.historical_data = pd.read_csv('data/historical_mlb_games.csv')
            ...
            print("Error: Could not load data/historical_mlb_games.csv")
            return False
    ...
    def check_data_freshness(self):
        ...
        if days_since_update >= 7:
            ...
            print(f"WARNING: Data is {days_since_update} days old - will check last 10 days")
            return False
        elif days_since_update >= 3:
            self.days_to_check = 7   # Haven't run in 3+ days - check week
            print(f"WARNING: Data is {days_since_update} days old - will check last 7 days")
            return False
        elif hours_since_update > 18:
            self.days_to_check = 3   # Daily updates - check last 3 days
            print(f"WARNING: Data is {hours_since_update:.1f} hours old - will check last 3 days")
            return False
        else:
            print("SUCCESS: Historical data is current")
            return True
    ...
    def train_model(self):
        ...
        # Save model
        joblib.dump(self.model, 'models/production_mlb_model.pkl')
        print("SUCCESS: Model saved to models/production_mlb_model.pkl")
    ...
    def predict_game(self, home_team, away_team):
        ...
        if self.model is None:
            try:
                self.model = joblib.load('models/production_mlb_model.pkl')
                print("LOADED: Existing model")
            except:
                print("TRAINING: No saved model found - training new model...")
                self.train_model()
    ...
    def generate_daily_predictions(self):
        ...
        for game in todays_games:
            ...
            if prediction['confidence'] in ['HIGH', 'MEDIUM']:
                ...
                print(f"  WARNING: Skip - Low confidence prediction")
...
def main():
    ...
    if not system.check_data_freshness():
        ...
        system.historical_data = pd.read_csv('data/historical_mlb_games.csv')
    ...
    if predictions:
        ...
        print("\nWARNING: No predictions generated (no games scheduled)")
